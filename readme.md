...
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Project Architecture**  | Overview of the system architecture including microservices, frontend, database, and infrastructure components.<br><br>📄 [Architecture Details](docs/architecture.md) |
